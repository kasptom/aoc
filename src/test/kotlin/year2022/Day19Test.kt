...
class Day19Test {
    ...
    @Test
    fun `should produce the expected test 0 result`() {
        // given
        val input = listOf(
        ...
        // then
        assertEquals(listOf(Pair(1, 9), Pair(2, 12)), result)
        assertEquals(33, sum)
    }

    @Test
    fun `should produce the expected test 1 result`() {
        // given
        val input = listOf(
            "Blueprint 1: Each ore robot costs 4 ore. Each clay robot costs 2 ore. Each obsidian robot costs 3 ore and 14 clay. Each geode robot costs 2 ore and 7 obsidian.",
            "Blueprint 2: Each ore robot costs 2 ore. Each clay robot costs 3 ore. Each obsidian robot costs 3 ore and 8 clay. Each geode robot costs 3 ore and 12 obsidian."
...
//        val sum = result.sumOf { (id, maxGeods) -> id * maxGeods }
        ...
        // then
        assertEquals(Pair(2, 62), result[1])
        assertEquals(Pair(1, 56), result[0])
    }

    @Test
    fun `should produce the expected part1 results`() {
        // given
        val input = listOf(
        ...
        // then
        assertEquals(firstPartAnswer, result)
    }
}